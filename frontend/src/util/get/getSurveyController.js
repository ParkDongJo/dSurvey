...
const address = '0xe838389530dae906f2ffb6ab577bc98a19985a89'

let SurveyController = new Promise(function (resolve, reject) {
  let surveyControllerABI = contract(SurveyCtrlContract)
  surveyControllerABI.setProvider(window.web3.currentProvider)
  surveyControllerABI.at(address).then(instance => {
    resolve({
